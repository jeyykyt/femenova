<div class="modal fade" id="storeBlogUserModal" tabindex="-1" aria-labelledby="editAchievementModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="p-3 p-xl-4" method="post" action="{{ route('blogUser.store') }}">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="form-check" style="width: 400px;">
                        <input class="form-check-input" type="checkbox" id="formCheck-1" name="anonymous">
                        <label class="form-check-label" for="formCheck-1" style="font-size: 14px;">Anonymous?</label>
                    </div>
