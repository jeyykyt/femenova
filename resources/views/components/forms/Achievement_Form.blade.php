    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="achievementModalLabel" style="font-family: Montserrat, sans-serif; color: #f13e3e; --bs-info: #f13e3e; --bs-info-rgb: 241,62,62; font-weight: bold;">FemeNova Health Achievement Form</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{route('achievement.store')}}" method="POST" enctype="multipart/form-data" style="border-color: #ed6662;">
                    @csrf
                    <div class="mb-3">
                        <label class="form-label" for="project_name" style="font-family: Montserrat, sans-serif;">Project Name:</label>
                        <input class="form-control" type="text" id="project_name" name="project_name" data-bs-theme="light">
                        @error('project_name')
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" id="place" name="place" data-bs-theme="light">
                        @error('place')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                        </div>
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" id="date" name="date" data-bs-theme="light">
                        @error('date')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="details" name="details" data-bs-theme="light"></textarea>
                        @error('details')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
