<div class="modal fade" id="deleteAchievementModal-{{ $achievement->id }}" tabindex="-1" aria-labelledby="editAchievementModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h4> Are you sure you want to delete {{ $achievement-> project_name }} ?</h4>
