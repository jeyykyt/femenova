<div class="modal fade" id="deleteBookModal-{{ $book->id }}" tabindex="-1" aria-labelledby="editBookModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h4> Are you sure you want to delete {{ $book-> book_title }} ?</h4>
