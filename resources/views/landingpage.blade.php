...
<body>
<div class="relative bg-cover bg-center bg-custom-gradient" style="background-image: url('{{ asset('img/lp_bg.png') }}');">
    <header class="absolute inset-x-0 top-0 z-50">
        <nav class="flex items-center justify-between p-2 lg:px-6" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:flex-1 lg:gap-x-12 lg:justify-end">
                ...
                <a href="/login" class="text-sm font-semibold leading-6 text-gray-900">Blogs</a>
                <a href="/contactus" class="text-sm font-semibold leading-6 text-gray-900">Contacts</a>
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div class="max-w-2xl py-32 sm:py-48 lg:py-56 text-left" style="margin-left: 1in; margin-right: 1in">
            <div class="text-left">
                <h1 class="text-4xl font-bold tracking-normal text-black sm:text-6xl">WELCOME TO FEMENOVA HEALTH!</h1>
                <p class="mt-6 text-lg leading-8 text-black-200">Empowering women, breaking taboos, and </p>
                    <p class=" text-lg leading-8 text-black-200">fostering supportive community around</p>
